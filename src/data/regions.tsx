...
export const SeaOfSustainability: Region = {
  title: { textParts: ['Sea Of', 'Sustainability'], coordinates: { x: -200, y: -150 } },
  regionKey: 'seaOfSustainability',
  color: '#00ACFF',
  filColour: 'transparent',
  customElement: () => (
    <rect id="seaOfSustainability" x={-280} y={-160} width="150" height="165" style={{ fill: 'transparent' }} />
  ),
  regionOwl: {
    regionOwl: '/static/image/owls/sea-of-sustainability.svg',
    regionOwlGif: '/static/image/owls/gif/blue-owl-sea-of-sustainibility.gif',
    x: '-275',
    y: '-70',
  },
  experiences: [],
...
export const PlayfulPlains: Region = {
  title: { textParts: ['Playful', 'Plains'], coordinates: { x: -200, y: 150 } },
  regionKey: 'playfulPlains',
  color: '#936EF1',
  filColour: 'black',
  drawing:
  ...
  regionOwl: {
    regionOwl: '/static/image/owls/playful-plains.svg',
    regionOwlGif: '/static/image/owls/gif/purple-owl-playful-plains.gif',
    x: '-150',
    y: '80',
  },
  experiences: [],
...
export const LoyaltyLagoon: Region = {
  title: { textParts: ['Loyalty', 'Lagoon'], coordinates: { x: -50, y: 230 } },
  regionKey: 'loyaltyLagoon',
  color: '#FF3FA0',
  filColour: 'black',
  ...
  regionOwl: {
    regionOwl: '/static/image/owls/loyalty-lagoon.svg',
    regionOwlGif: '/static/image/owls/gif/pink-owl-loyalty-lagoon.gif',
    x: '15',
    y: '200',
  },
...
export const CreativityCoasts: Region = {
  ...
  regionOwl: {
    regionOwl: '/static/image/owls/creativity-coast.svg',
    regionOwlGif: '/static/image/owls/gif/red-owl-creativity-coast.gif',
    x: '1020',
    y: '720',
  },
...
export const TimelessTundra: Region = {
  title: { textParts: ['Timeless', 'Tundra'], coordinates: { x: 310, y: 10 } },
  regionKey: 'timelessTundra',
  color: '#c09b45f0',
  filColour: 'black',
  ...
  regionOwl: {
    regionOwl: '/static/image/owls/gold-owl.svg',
    regionOwlGif: '/static/image/owls/gif/gold-owl-timeless-tundra.gif',
    x: '360',
    y: '30',
  },
  experiences: [],
...
export const VirtualValleys: Region = {
  title: { textParts: ['Virtual', 'Valleys'], coordinates: { x: 60, y: -80 } },
  regionKey: 'virtualValleys',
  color: '#00B16E',
  filColour: 'black',
  ...
  regionOwl: {
    regionOwl: '/static/image/owls/virtual-valleys.svg',
    regionOwlGif: '/static/image/owls/gif/green-owl-virtual-valleys.gif',
    x: '70',
    y: '-130',
  },
  experiences: [],
