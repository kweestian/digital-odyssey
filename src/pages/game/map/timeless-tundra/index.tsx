...
import Certificate from '@/image/map/timeless-tundra/certificate.svg';
  ...
  <GameLayout>
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        Congratulations, you're now part of the Digital Odyssey community of finishers. Download your <br /> certificate
        and post-it on our internal network Workplace
      </p>
